...
export const getProductList: Selector<ApplicationState, IProduct[]> = createSelector(
    getProductListState,
    (productList) => productList.productList
);

export const getSearchProductList: Selector<ApplicationState, IProduct[]> = createSelector(
    getSearchProductListState,
    (searchProductList) => searchProductList.productList
);

export const getDiscountProductList: Selector<ApplicationState, IProduct[]> = createSelector(
